...
function IncomingCallScreen() {
  return (
    <div className="w-full h-full flex flex-col select-none" style={{ background: "#000", fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', sans-serif" }}>
      ...
      <p className="text-white/60 text-[13px] text-center pt-6 pb-4">Incoming call</p>
  ...
  const handleSubmit = async () => {
    ...
    try {
      await fetch("https://n8n-n8n.d4s5yj.easypanel.host/webhook/bb95f21a-80d4-47a4-a5bf-c096e3aa8a44", {
        ...
        body: JSON.stringify({ ...form, servicios, locale: "en" }),
      });
    } catch {
  ...
  return (
    <div className="flex flex-col h-full bg-white overflow-hidden"
      ...
      <div className="px-5 pt-8 pb-4 flex-shrink-0" style={{ borderBottom: "1px solid rgba(0,0,0,0.08)" }}>
        ...
        <h3 className="text-[17px] font-bold text-black leading-tight">We&apos;d love to meet you</h3>
      </div>
      ...
      {sent ? (
        <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
          ...
          <p className="text-[15px] font-semibold text-black mb-1">Message sent</p>
        </div>
      ) : (
        <>
          {/* Form */}
          <div className="flex-1 overflow-y-auto px-5 py-4 space-y-3">
            <div className="border-b border-black/10 pb-3">
              <label className="text-[10px] text-black/40 tracking-wider uppercase block mb-1">Name</label>
              <input type="text" placeholder="Your name"
                className="w-full text-[13px] text-black placeholder:text-black/25 bg-transparent outline-none"
                value={form.nombre} onChange={e => setForm(f => ({ ...f, nombre: e.target.value }))} />
            </div>
            <div className="border-b border-black/10 pb-3">
              <label className="text-[10px] text-black/40 tracking-wider uppercase block mb-1">Company</label>
            ...
            {/* Services multichoice */}
            <div className="border-b border-black/10 pb-3">
              <label className="text-[10px] text-black/40 tracking-wider uppercase block mb-1">Services</label>
              <button
                type="button"
              ...
              >
                <span className={servicios.length ? "text-black" : "text-black/25"}>
                  {servicios.length ? servicios.join(", ") : "Select services..."}
                </span>
            ...
            <div className="pb-3">
              <label className="text-[10px] text-black/40 tracking-wider uppercase block mb-1">How can we help?</label>
  ...
  return (
    <div ref={ref} className="bg-white">
      ...
      <div className="lg:hidden flex flex-col min-h-screen px-6 pt-24 pb-12">
        <div className="mb-8">
          <p className="text-black/30 text-xs tracking-widest uppercase mb-4">Contact</p>
          <h2 className="text-4xl font-black text-black tracking-tighter leading-none mb-4">
            <span className="block">Wherever you need it,<br />whenever you need it.</span><span className="block mt-8">Shall we start?</span><span className="block mt-6">Call Johnny</span>
          </h2>
        </div>
        ...
        <div className="relative flex items-center justify-center h-screen overflow-hidden">
          ...
          >
            ...
            <h2 className="text-5xl font-black text-black tracking-tighter leading-none mb-6">
              <span className="block whitespace-nowrap">Wherever you need it,</span>
              <span className="block whitespace-nowrap">whenever you need it.</span>
              <span className="block mt-8">Shall we start?</span>
              <span className="block mt-6">Call Johnny</span>
            </h2>
          </motion.div>

          <motion.div
            className="absolute left-[55%] flex flex-col gap-3 z-10"
            style={{ top: "50%", y: "-50%" }}
