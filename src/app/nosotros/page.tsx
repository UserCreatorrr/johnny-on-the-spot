      ...
      <section className="sticky top-0 h-screen flex items-center px-6 lg:px-8 bg-white overflow-hidden" aria-label="Clientes">
        <div className="max-w-7xl mx-auto w-full">
          ...
          <div className="flex flex-wrap gap-x-10 gap-y-8 items-center">
            {[
              { name: "Alcon",            file: "Alcon-Emblem.png",                                          h: 23, maxW: 23   },
              { name: "Novartis",         file: "novartis.png",                                              h: 33, maxW: 100  },
              { name: "Coca-Cola",        file: "cocacola.png",                                              h: 30, maxW: 100  },
              { name: "SAP",              file: "SAP_2011_logo.svg.png",                                     h: 20, maxW: 50   },
              { name: "Porsche",          file: "porsche-logo-0.png",                                        h: 65, maxW: 65   },
              ...
              { name: "Carolina Herrera", file: "carolina-herrera-logo-0.png",                               h: 50, maxW: 90   },
              { name: "Haribo",           file: "Haribo-logo.png",                                           h: 23, maxW: 73   },
              { name: "Glenfiddich",      file: "glenfiddich-logo-png-2-Transparent-Images.png",             h: 30, maxW: 70   },
              { name: "IKEA",             file: "ikea.png",                                                  h: 35, maxW: 73   },
              { name: "Perrier",          file: "Perrier_logo.svg.png",                                      h: 25, maxW: 60   },
              { name: "ISDIN",            file: "isdin.png",                                                 h: 33, maxW: 100  },
              { name: "Ipsen Farma",      file: "Ipsen_logo.svg.png",                                        h: 23, maxW: 80   },
              { name: "Coty Prestige",    file: "Coty_Inc_logo_2016.png",                                    h: 35, maxW: 100  },
              { name: "GFT",              file: "GFT-Technologies_Logo_SafeSpace_DarkBlue_rgb_2025.svg.png", h: 20, maxW: 90   },
              { name: "Applus",           file: "LOGO-APPLUS.png",                                           h: 20, maxW: 75   },
