            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2.5rem", borderTop: "1px solid rgba(255,255,255,0.12)", paddingTop: "1.8rem" }}>
              <div>
                ...
                <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                    <li key="Estrategia" style={{ color: "rgba(255,255,255,0.72)", fontSize: "0.8rem", lineHeight: "1.7" }}>Estrategia</li>
                    ...
                    <li key="Producción Gráfica" style={{ color: "rgba(255,255,255,0.72)", fontSize: "0.8rem", lineHeight: "1.7" }}>Producción Gráfica</li>
                    <li key="Guionización" style={{ color: "rgba(255,255,255,0.72)", fontSize: "0.8rem", lineHeight: "1.7" }}>Guionización</li>
                    <li key="Rodaje Mini Serie" style={{ color: "rgba(255,255,255,0.72)", fontSize: "0.8rem", lineHeight: "1.7" }}>Rodaje Mini Serie</li>
                    <li key="Videos Contenido" style={{ color: "rgba(255,255,255,0.72)", fontSize: "0.8rem", lineHeight: "1.7" }}>Videos Contenido</li>
                    <li key="Realidad Aumentada" style={{ color: "rgba(255,255,255,0.72)", fontSize: "0.8rem", lineHeight: "1.7" }}>Realidad Aumentada</li>
                    <li key="Web & App" style={{ color: "rgba(255,255,255,0.72)", fontSize: "0.8rem", lineHeight: "1.7" }}>Web & App</li>
                    <li key="Roadshow" style={{ color: "rgba(255,255,255,0.72)", fontSize: "0.8rem", lineHeight: "1.7" }}>Roadshow</li>
                    <li key="Producción & Logística" style={{ color: "rgba(255,255,255,0.72)", fontSize: "0.8rem", lineHeight: "1.7" }}>Producción & Logística</li>
                    <li key="Staff & F&B" style={{ color: "rgba(255,255,255,0.72)", fontSize: "0.8rem", lineHeight: "1.7" }}>Staff & F&B</li>
                </ul>
              </div>
              <div>
                <p style={{ color: "rgba(255,255,255,0.3)", fontSize: "0.58rem", letterSpacing: "0.22em", textTransform: "uppercase", fontWeight: 700, margin: "0 0 0.9rem" }}>
                ...
                <ul style={{ listStyle: "none", padding: 0, margin: "0 0 1.8rem" }}>
                    ...
                    <li key="Eventos" style={{ color: "rgba(255,255,255,0.72)", fontSize: "0.8rem", lineHeight: "1.7" }}>Eventos</li>
                    <li key="Activación & Experiencias" style={{ color: "rgba(255,255,255,0.72)", fontSize: "0.8rem", lineHeight: "1.7" }}>Activación & Experiencias</li>
