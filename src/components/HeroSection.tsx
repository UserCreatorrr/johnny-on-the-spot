  ...
  return (
    ...
    >
      <div className="sticky top-0 h-screen overflow-hidden bg-black">
        ...
        {/* Video background — full screen, always playing */}
        <video
        ...
        {/* Dark overlay so logo remains readable */}
        <div className="absolute inset-0 bg-black/50" aria-hidden="true" />

        {/* White panel slides in from right, covers video */}
        <div
        ...
        {/* Logo — mix-blend-mode: difference auto-inverts on white panel */}
        <div
