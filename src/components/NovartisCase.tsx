      ...
      <div style={{ height: "310vh", position: "relative" }}>
        <div style={{ position: "sticky", top: 0, height: "100vh", overflow: "hidden", background: "#000" }}>
          ...
          <video ref={videoRef} autoPlay muted={muted} loop playsInline className="video-portrait-fit" style={{
            ...
            <source src="https://evolutionapi-video-jots.d4s5yj.easypanel.host/NOVARTIS%20Tiempo%20para%20crecer.mp4" type="video/mp4" />
          </video>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(1rem, 2vw, 2.5rem)", borderTop: "1px solid rgba(255,255,255,0.12)", paddingTop: "clamp(0.8rem, 1.5vh, 1.8rem)" }}>
              <div>
                ...
                <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                    ...
                    <li key="Congreso" style={{ color: "rgba(255,255,255,0.72)", fontSize: "clamp(0.7rem, 1.2vw, 0.8rem)", lineHeight: "1.6" }}>Congreso</li>
                    <li key="Stand" style={{ color: "rgba(255,255,255,0.72)", fontSize: "clamp(0.7rem, 1.2vw, 0.8rem)", lineHeight: "1.6" }}>Stand</li>
                    <li key="Video" style={{ color: "rgba(255,255,255,0.72)", fontSize: "clamp(0.7rem, 1.2vw, 0.8rem)", lineHeight: "1.6" }}>Video</li>
                    <li key="Localización" style={{ color: "rgba(255,255,255,0.72)", fontSize: "clamp(0.7rem, 1.2vw, 0.8rem)", lineHeight: "1.6" }}>Localización</li>
