            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2.5rem", borderTop: "1px solid rgba(255,255,255,0.12)", paddingTop: "1.8rem" }}>
              <div>
                ...
                <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                    ...
                    <li key="Comunicación Interna" style={{ color: "rgba(255,255,255,0.72)", fontSize: "0.8rem", lineHeight: "1.7" }}>Comunicación Interna</li>
                    <li key="Web Dedicado" style={{ color: "rgba(255,255,255,0.72)", fontSize: "0.8rem", lineHeight: "1.7" }}>Web Dedicado</li>
                    <li key="Videos" style={{ color: "rgba(255,255,255,0.72)", fontSize: "0.8rem", lineHeight: "1.7" }}>Videos</li>
                    <li key="Actividades" style={{ color: "rgba(255,255,255,0.72)", fontSize: "0.8rem", lineHeight: "1.7" }}>Actividades</li>
                    <li key="Localizaciones" style={{ color: "rgba(255,255,255,0.72)", fontSize: "0.8rem", lineHeight: "1.7" }}>Localizaciones</li>
                    <li key="Producción" style={{ color: "rgba(255,255,255,0.72)", fontSize: "0.8rem", lineHeight: "1.7" }}>Producción</li>
                    <li key="Staff & F&B" style={{ color: "rgba(255,255,255,0.72)", fontSize: "0.8rem", lineHeight: "1.7" }}>Staff & F&B</li>
                    <li key="Logística & Viajes" style={{ color: "rgba(255,255,255,0.72)", fontSize: "0.8rem", lineHeight: "1.7" }}>Logística & Viajes</li>
                </ul>
              </div>
              <div>
                <p style={{ color: "rgba(255,255,255,0.3)", fontSize: "0.58rem", letterSpacing: "0.22em", textTransform: "uppercase", fontWeight: 700, margin: "0 0 0.9rem" }}>
