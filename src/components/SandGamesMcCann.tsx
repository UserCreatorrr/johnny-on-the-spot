      ...
      <div style={{ height: "310vh", position: "relative" }}>
        <div style={{ position: "sticky", top: 0, height: "100vh", overflow: "hidden", background: "#000" }}>
          ...
          <video ref={videoRef} autoPlay muted={muted} loop playsInline className="video-portrait-fit" style={{
            ...
            <source src="https://evolutionapi-video-jots.d4s5yj.easypanel.host/SD_TheSandGames_ShortClip_220516.mp4" type="video/mp4" />
          </video>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(1rem, 2vw, 2.5rem)", borderTop: "1px solid rgba(255,255,255,0.12)", paddingTop: "clamp(0.8rem, 1.5vh, 1.8rem)" }}>
              <div>
                ...
                <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                    ...
                    <li key="Comunicación Interna" style={{ color: "rgba(255,255,255,0.72)", fontSize: "clamp(0.7rem, 1.2vw, 0.8rem)", lineHeight: "1.6" }}>Comunicación Interna</li>
                    <li key="Web Dedicado" style={{ color: "rgba(255,255,255,0.72)", fontSize: "clamp(0.7rem, 1.2vw, 0.8rem)", lineHeight: "1.6" }}>Web Dedicado</li>
                    <li key="Videos" style={{ color: "rgba(255,255,255,0.72)", fontSize: "clamp(0.7rem, 1.2vw, 0.8rem)", lineHeight: "1.6" }}>Videos</li>
                    <li key="Actividades" style={{ color: "rgba(255,255,255,0.72)", fontSize: "clamp(0.7rem, 1.2vw, 0.8rem)", lineHeight: "1.6" }}>Actividades</li>
                    <li key="Localizaciones" style={{ color: "rgba(255,255,255,0.72)", fontSize: "clamp(0.7rem, 1.2vw, 0.8rem)", lineHeight: "1.6" }}>Localizaciones</li>
                    <li key="Producción" style={{ color: "rgba(255,255,255,0.72)", fontSize: "clamp(0.7rem, 1.2vw, 0.8rem)", lineHeight: "1.6" }}>Producción</li>
                    <li key="Staff & F&B" style={{ color: "rgba(255,255,255,0.72)", fontSize: "clamp(0.7rem, 1.2vw, 0.8rem)", lineHeight: "1.6" }}>Staff & F&B</li>
                    <li key="Logística & Viajes" style={{ color: "rgba(255,255,255,0.72)", fontSize: "clamp(0.7rem, 1.2vw, 0.8rem)", lineHeight: "1.6" }}>Logística & Viajes</li>
                </ul>
              </div>
              <div>
                <p style={{ color: "rgba(255,255,255,0.3)", fontSize: "0.55rem", letterSpacing: "0.22em", textTransform: "uppercase", fontWeight: 700, margin: "0 0 0.6rem" }}>
